...
// Transaction トランザクション情報を格納した構造体。
...
// GenerateSignature シグネチャを生成するメソッド。
...
// MarshalJSON トランザクション構造体をマーシャルするためのカスタムマーシャル。
